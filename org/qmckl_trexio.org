...
*** Number of numerical orbital spline data points
   ...
   #+begin_src c :tangle (eval c)
  int64_t nao_grid_num = 0L;
  if (basis_type[0] == 'N') {

    rcio = trexio_read_basis_nao_grid_num_64(file, &nao_grid_num);
    if (rcio != TREXIO_SUCCESS) {
      return qmckl_failwith( context,
                             QMCKL_FAILURE,
    ...
    assert (nao_grid_num > 0);
    rc = qmckl_set_ao_basis_nao_grid_num(context, nao_grid_num);
...
*** Start indices of splines
  ...
  if (basis_type[0] == 'N'){
    ...
    int64_t* nao_grid_start = (int64_t*) qmckl_malloc(context, mem_info);

    if (nao_grid_start == NULL) {
      return qmckl_failwith( context,
                             QMCKL_ALLOCATION_FAILED,
                             "qmckl_trexio_read_basis_nao_grid_start_X",
                             NULL);
    }

    assert (nao_grid_start != NULL);

    /* Read data */
    rcio = trexio_read_safe_basis_nao_grid_start_64(file, nao_grid_start, shell_num);
    if (rcio != TREXIO_SUCCESS) {
      qmckl_free(context, nao_grid_start);
      nao_grid_start = NULL;
      return qmckl_failwith( context,
                             QMCKL_FAILURE,
    ...
    /* Store data */
    rc = qmckl_set_ao_basis_nao_grid_start(context, nao_grid_start, shell_num);
...
*** Number of data points per spline
  ...
  if (basis_type[0] == 'N'){
    ...
    int64_t* nao_grid_size = (int64_t*) qmckl_malloc(context, mem_info);

    if (nao_grid_size == NULL) {
      return qmckl_failwith( context,
                             QMCKL_ALLOCATION_FAILED,
                             "qmckl_trexio_read_basis_nao_grid_size_X",
                             NULL);
    }

    assert (nao_grid_size != NULL);

    /* Read data */
    rcio = trexio_read_safe_basis_nao_grid_size_64(file, nao_grid_size, shell_num);
    if (rcio != TREXIO_SUCCESS) {
      qmckl_free(context, nao_grid_size);
      nao_grid_size = NULL;
      return qmckl_failwith( context,
                             QMCKL_FAILURE,
    ...
    /* Store data */
    rc = qmckl_set_ao_basis_nao_grid_size(context, nao_grid_size, shell_num);
...
*** Radial values of spline data
  ...
  if (basis_type[0] == 'N'){
    ...
    double* nao_grid_radius = (double*) qmckl_malloc(context, mem_info);

    if (nao_grid_radius == NULL) {
      return qmckl_failwith( context,
                             QMCKL_ALLOCATION_FAILED,
                             "qmckl_trexio_read_basis_nao_grid_radius_X",
                             NULL);
    }

    assert (nao_grid_radius != NULL);

    /* Read data */
    rcio = trexio_read_safe_basis_nao_grid_radius_64(file, nao_grid_radius, nao_grid_num);
    if (rcio != TREXIO_SUCCESS) {
      qmckl_free(context, nao_grid_radius);
      nao_grid_radius = NULL;
      return qmckl_failwith( context,
                             QMCKL_FAILURE,
    ...
    /* Store data */
    rc = qmckl_set_ao_basis_nao_grid_radius(context, nao_grid_radius, nao_grid_num);
...
*** Interpolator for wave function
  ...
  if (basis_type[0] == 'N'){
    ...
    /* Allocate array for data */
    int64_t data_size = nao_grid_num * interp_coeff_cnt;
